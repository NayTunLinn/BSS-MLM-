...
{
    public class ReligionDataCtrl:GlobalDataAccess
    {
         #region Variables
       ...
       public ReligionDataCtrl()
        ...
        {
            base.sqlcmd = "ReligionSelect";
            xsdCodeSetup.ReligionDataTable dataTable = new xsdCodeSetup.ReligionDataTable();
        ...
        public string Insert(xsdCodeSetup.ReligionRow dataRow)
        {
            sqlcmd = "ReligionInsert";
            ...
            try
            {
                command.Parameters.AddWithValue("@Religion", dataRow.Religion);
