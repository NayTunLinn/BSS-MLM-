    ...
    public partial class SaleReturnInvoice : Form
    {
        ...
        public SaleReturnInvoice()
            ...
            public void DataBind()
            {
                ...
                dgvInvoiceView.DataSource = s_controller.ReturnInvoiceSelectByMonth();
            ...
            private void dgvInvoiceView_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
            {
                ...
                dgvInvoiceDetails.DataSource = s_controller.ReturnInvoiceDetailsSelectById(InvId);
            ...
            {
                xsdSaleReport.Invoice_ReportDataTable dt = s_controller.ReturnInvoiceSelect();
            ...
            {
                dgvInvoiceView.AutoGenerateColumns = false;
                dgvInvoiceView.DataSource = s_controller.ReturnInvoiceSelectByGeneral(PostSql);
            }
            ...
            private void btnReceipt_Click(object sender, EventArgs e)
            {
                ...
                if (key != string.Empty)
                {
                    Reporting.SaleReport sp = new Reporting.SaleReport(key, "");
                    sp.ShowDialog();
                }
            }
