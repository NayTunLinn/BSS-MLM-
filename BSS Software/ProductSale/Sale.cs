...
namespace BSSSoftware.SaleReturnReport
{
    public partial class Sale : Form
    {
        ...
        #region Variables
        private SaleControl S_controller = null;
      ...
      //  string InvId;
        ...
        xsdSale.SaleInsertDataTable SaleInsertDt = null;
        xsdSale.InvoiceDataTable InvoiceDT = null;

        AutoCompleteStringCollection UpperCodeAutoCompleteCollection = null;

        //  xsdSale.InvoiceDetailsDataTable InvDetailDataTable = null;
        //  private produ
        ...
        public void Initializing()
        {
            ...
            S_controller = new SaleControl();
            P_controller = new ProductControl();
            su_controller = new AllProductSummeryControls();
            G_controller = new GeneralControl();
            SaleInsertDt = new xsdSale.SaleInsertDataTable();
            InvoiceDT = new xsdSale.InvoiceDataTable();
        ...
        private void  SaveHeaderDetail()
        {
            ...
            try
            {
                if (MessageBox.Show(this, "Are you sure to save?", "Confirmation", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    ...
                    xsdSale.InvoiceRow datarow = getHeader();
                    xsdSale.SaleInsertDataTable dt = GetItem();
        ...
        private xsdSale.InvoiceRow getHeader()
        {
            xsdSale.InvoiceRow InvRow = InvoiceDT.NewInvoiceRow();
            // InvRow.CustomerId = customerId;
            InvRow.UpperDistributerId = UpperdistId; 
            InvRow.InvNo = G_controller.AutoGenerateCode("Invoice");

            InvRow.InvDate = dtpkDate.Value.Date;
            InvRow.Title = "";
        ...
        xsdSale.SaleInsertDataTable GetItem()
        {
            SaleInsertDt = new xsdSale.SaleInsertDataTable();
            xsdSale.SaleInsertRow d_row;

            foreach (DataGridViewRow row in dgvSale.Rows)
            {
                d_row = SaleInsertDt.NewSaleInsertRow();
                ...
                SaleInsertDt.AddSaleInsertRow(d_row);
            }
        ...
        private void txtUpperDistCode_TextChanged(object sender, EventArgs e)
        {
        ...
        private void AutoBnding()
        {
            ...
            char ch = str[0];
                switch (ch)
                {
                    ...
                    default:
                        // CompanyControl Co_control = new CompanyControl();
        ...
        private void MyRefresh()
        {
            ...
            txtTotal.Clear();
            txtCash.Clear();
            // xsdSale.SaleInsertRow d_row = SaleInsertDt.NewSaleInsertRow();
            SaleInsertDt = new xsdSale.SaleInsertDataTable();
        ...
        {
            SaleReturnReport.SearchInvoice si = new SearchInvoice();
            si.Show();
        }
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Your invoice is empty.");
                itclick = false;
                return;
            }
            try
            {
                Reporting.SaleReport sp = new SaleReport(InvId,"Sale");
                sp.ShowDialog();
                itclick = true;
            }
            catch (Exception ex)
        ...
        private void txtUpperDistCode_Validated(object sender, EventArgs e)
        {
