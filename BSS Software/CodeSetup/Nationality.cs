...
namespace BSSSoftware.CodeSetup
{
    public partial class Nationality : Form
    {
        ...
        #region Variables
        private NationalityControl m_controller = null;
        string key = null;
        #endregion
        ...
        {
            m_controller = new NationalityControl();
            GridViewDataBind();
        }
        ...
        {
            if (txtnationality.Text.Equals(null)) return;
            xsdCodeSetup.NationalityRow dataRow = (new xsdCodeSetup.NationalityDataTable()).NewNationalityRow();
            try
            {

                dataRow.Nationality = txtnationality.Text.Trim();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            if (dataRowView != null)
            {
                string key = Global.GetDataFromRow<string>(dataRowView.Row, "NationalityId", string.Empty);
                this.txtnationality.Text = Global.GetDataFromRow<string>(dataRowView.Row, "Nationality", string.Empty);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (dataRowView != null)
            {
                key = Global.GetDataFromRow<string>(dataRowView.Row, "NationalityId", string.Empty);
            }
            this.Delete(key);
            GridViewDataBind();
        }
